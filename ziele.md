...
- Implementierung und Optimierung des Stadtklimamodells PALM-4U in verschiedenen Auflösungen (20m und 1m)
- Validierung und Bias-Korrektur mittels meteorologischer Beobachtungsdaten und Messreihen seit 2018
- Bereitstellung relevanter Wetterlagen und Klimaszenarien für die Stadtentwicklungsplanung
- Anwendung von KI-Verfahren zur Verbesserung der Modellqualität und Beschleunigung der Simulationen



![Digitaler Zwilling der Stadt Würzburg](/images/ziele/dz-wuerzburg.jpeg)
...
- Gewinnung hochauflösender Inputdaten durch Laserscanning (ALS/TLS) und Drohnenbefliegungen
- Thermische Befliegungen zur Validierung der Stadtklimasimulationen
- Auswertung von Geodaten mittels Machine-Learning-Algorithmen
- Bereitstellung von Infrarotbildern, Orthophotos und Satellitendaten für den Urbanen Digitalen Zwilling

![Luftaufnahmen der Stadt Würzburg](images/ziele/luftaufnahmen.png)*Verschiedene Luftaufnahmen der Stadt Würzburg* 

## Beiträge des Lehrstuhls für Data Science

- KI-basierte Optimierung und Beschleunigung des Stadtklimamodells PALM-4U mittels Deep Learning
- Programmierung von Datenschnittstellen zwischen dem Urbanen Digitalen Zwilling und PALM-4U
- Entwicklung eines nutzerfreundlichen Userinterface zur Steuerung des Stadtklimamodells
- Integration frei kombinierbarer Szenario-Ebenen (Wetterlagen, Klimaszenarien, Stadtentwicklung)
